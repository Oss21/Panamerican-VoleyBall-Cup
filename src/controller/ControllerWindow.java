...
public class ControllerWindow {
    ...
    @FXML
    public void btExplore(ActionEvent event) {
    ...
    @FXML
    public void btSearchCompetitor(ActionEvent event) {
    ...
    @FXML
    public void btSearchViewer(ActionEvent event) {
    ...
    @FXML
    public void  SearchViewerByCountry(ActionEvent event) {
    	int layouX = 0;
    	int layouY = 0;
    	int x = 0;
    	int y = 0;
		...
		for (int i = 0; i < viewer.size()&& !found; i++) {
			...
			vbox2.setLayoutX(x);
  			...
  			text2.setText(viewer.get(i).toString());
...
//  			//Derecha
  			if(i+2 < viewer.size()) {
  	    		...
  	    		image3.setImage(new Image(viewer.get(i+=1).getPhoto()));
  	    		TextArea text3 = new TextArea();
  	    		text3.setText(viewer.get(i).toString());
